...
export default function Layout() {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
      {/* Cinematic background — dark mode only (hidden in light via CSS) */}
      <div style={{ position: 'fixed', inset: 0, zIndex: 0, overflow: 'hidden', background: theme === 'light' ? '#F7F8FA' : 'transparent' }}>
