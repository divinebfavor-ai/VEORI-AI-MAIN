  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-[420px] bg-card border border-border-subtle rounded-[12px] p-10">
        <h1 className="text-[22px] font-medium text-white mb-8">Sign in</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="flex justify-end mt-2">
              <button type="button" className="text-[12px] text-text-muted hover:text-text-secondary transition-colors">
                Forgot password?
              </button>
            </div>
          </div>
        ...
        {/* Google */}
        <Button variant="secondary" className="w-full gap-3" size="md">
