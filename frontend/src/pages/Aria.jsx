  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }} className="group">
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4, maxWidth: '75%' }}>
        ...
        {timestamp && (
          <span style={{ fontSize: 10, color: 'var(--t4)', opacity: 0, transition: 'opacity 0.2s' }} className="group-hover:opacity-100">
      ...
      <aside style={{
        ...
        <div style={{ padding: '12px 12px 8px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 8 }}>
          <button
            ...
            onMouseEnter={e => { e.currentTarget.style.background = 'var(--surface-bg-2)'; e.currentTarget.style.color = 'var(--t1)' }}
            onMouseLeave={e => { e.currentTarget.style.background = 'var(--surface-bg)'; e.currentTarget.style.color = 'var(--t3)' }}
          >
            <ArrowLeft size={13} />
            Back
          </button>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '10px 8px' }}>
                ...
                {convos.map(c => (
                  <button
                    ...
                    style={{
                      ...
                      background: activeId === c.id ? 'rgba(0,195,122,0.08)' : hoveredId === c.id ? 'var(--surface-bg)' : 'transparent',
          ...
          {conversations.length === 0 && (
            <div style={{ padding: '40px 12px', textAlign: 'center' }}>
              <MessageSquare size={20} style={{ color: 'var(--t4)', margin: '0 auto 8px', display: 'block' }} strokeWidth={1.5} />
              <p style={{ fontSize: 12, color: 'var(--t4)' }}>No conversations yet</p>
            </div>
          )}
        </div>
        ...
        <div style={{ padding: '14px 16px', borderTop: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <p style={{ fontSize: 12, fontWeight: 600, color: 'var(--t1)' }}>Aria</p>
              <p style={{ fontSize: 10, color: 'var(--t4)' }}>Real Estate Intelligence</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--t1)' }}>Aria</span>
            <span style={{ fontSize: 12, color: 'var(--t4)' }}>Real Estate Intelligence</span>
          </div>
          ...
          <div style={{ maxWidth: 740, margin: '0 auto', padding: '28px 24px', display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            {isEmpty ? (
              <div style={{
                ...
                <h1 style={{ fontSize: 28, fontWeight: 700, color: 'var(--t1)', letterSpacing: '-0.03em', marginBottom: 8 }}>
                  Hi, I'm Aria.
                </h1>
