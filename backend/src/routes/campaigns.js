...
router.put('/:id', async (req, res, next) => {
  try {
    const allowed = ['name','concurrent_lines','daily_limit_per_number','calling_hours_start','calling_hours_end','status','retry_attempts','call_delay_seconds','daily_spend_limit','lead_filter'];
